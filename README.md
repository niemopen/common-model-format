...
CMF is extensively described in the [NIEM Naming and Design Rules, Version 6.0](https://docs.oasis-open.org/niemopen/ndr/v6.0/ndr-v6.0.html).
...
The pre-OASIS history of CMF is at [NIEM-Metamodel (github.com)](https://github.com/NIEM/NIEM-Metamodel) 
